...
<link rel="stylesheet" href="<?php echo base_url("_assets/css/login2.css"); ?>">
     ...
     <center>
          ...
          echo form_open("NewCon/parent_login", $attributes);?>
          
               <img src="<?php echo base_url("_assets/img/logo5.png"); ?>" style="margin-bottom: 20px; size: 85%;"><br>
               <p style="margin-bottom: 30px;"><h3><b>My.ICI Parent Login </b></h3></p>
               <fieldset>
                    &nbsp;&nbsp;
                    <input type="text" style="width:250px; height: 37px; text-align: center; margin-bottom: 10px;" id="p_name" name="p_name" placeholder="Enter Fullname"/><br>
                    ...
                    <br><br>
                    <p><a href="<?php print(base_url().'index.php/NewCon/index') ?>">Click here</a> to access the Student Portal</p>
               </fieldset>
     </center>
     <?php echo form_close(); ?>
